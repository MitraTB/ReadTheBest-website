<template>
    <div>
  <b-navbar style="width:100%" type="light" variant="warning">
    <b-navbar-brand href="#"><strong>ReadTheBest</strong></b-navbar-brand>
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav>
        ...
        <b-nav-item href="/myBook">MyBook</b-nav-item>
        <b-nav-item-dropdown >
